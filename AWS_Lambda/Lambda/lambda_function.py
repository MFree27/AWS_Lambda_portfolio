...
def recommend_portfolio(intent_request):
    ...
    if  age > 64: return ("Sorry, I cannot recommend a portfolio for anyone 65 and older.")
    if  age < 65:
        return recommend_portfolio(intent_request)
    if investment_amount < 5000:
        return("Sorry, I cannot recommend a portfolio for an amount less than $5,000 dollars.")
    if investment_amount >= 5000:
        return recommend_portfolio(intent_request)
    if risk_level == "None":
    ...
    if risk_level == "High":
        return("Your recommended portfolio composition is: 20% bonds (AGG), 80% equities (SPY)")
